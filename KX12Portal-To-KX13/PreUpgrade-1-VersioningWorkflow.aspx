<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PreUpgrade-1-VersioningWorkflow.aspx.cs" Inherits="CMSPages_UpgradeToKX13Operations_PreUpgradeOperations_VersioningWorkflow" Theme="Default" MasterPageFile="~/CMSMasterPages/LiveSite/SimplePage.master" %>
...
<asp:Content ID="cnt" ContentPlaceHolderID="plcContent" runat="server">
    ...
    <div>
        ...
        <p><br /><strong>REMEMBER:</strong> <u>After the upgrade</u>, you will want to run the "Create Initial Version History" operation once to re-enable your Workflows and rebuild the Version History table so Staging Operations will work properly.</p>
        <asp:Button runat="server" ID="btnDisableWorkflowClearHistory" OnClick="btnDisableWorkflowClearHistory_Click" Text="Clear History" CssClass="btn btn-primary" />
